export default function Section7() {
	return (
		<section className="bg-blue-300 py-28 h-screen flex justify-end  items-end ">
			<div className="max-w-xl flex flex-col justify-end items-end">
				<div className="bg-black text-white flex justify-between gap-80 px-5 py-12 ">
